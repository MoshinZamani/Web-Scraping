// Lists name of all BlackDiamond belay devices
...
async function performScraping() {
  ...
  const axiosResponse = await axios.request({
    method: "GET",
    url: "https://www.blackdiamondequipment.com/en_GB/shop/climb/?sub_category=Harnesses&page=1",
    headers: {
      "User-Agent":
  ...
  for (let i = 0; i < names.length; i++) {
    harnesses.push({ name: names[i], link: links[i] });
  }
